...
contract MOPNERC6551AccountHelper is Multicall {
    ...
    function createAccount(
        ...
        return IERC6551Registry(ERC6551Registry).createAccount(implementation, chainId, tokenContract, tokenId, salt, initData);
    }
    ...
    function computeAccount(
        ...
        return IERC6551Registry(ERC6551Registry).account(implementation, chainId, tokenContract, tokenId, salt);
    }
    ...
    function checkAccountExist(
        ...
        _account = computeAccount(implementation, chainId, tokenContract, tokenId, salt);
