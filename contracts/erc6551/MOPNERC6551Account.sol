...
contract MOPNERC6551Account is IERC165, IERC1271, IERC721Receiver, IERC1155Receiver, IMOPNERC6551Account, Multicall {
    address public immutable accounthelper;

    uint256 public state;

    constructor(address accounthelper_) {
        accounthelper = accounthelper_;
    }
    ...
    function owner() public view returns (address) {
        ...
        if (tokenContract == 0xb47e3cd837dDF8e4c57F05d70Ab865de6e193BBB || tokenContract == 0x322813Fd9A801c5507c9de605d63CEA4f2CE6c44) {
    ...
    modifier onlyHelper() {
        if (msg.sender != accounthelper) revert NotAuthorized();
        _;
    }
}
