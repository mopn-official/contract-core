...
contract MOPNBomb is ERC1155, Multicall {
    string public name;
    ...
    modifier onlyMOPN() {
        require(msg.sender == address(mopn), "not allowed");
        _;
    }

    modifier onlyOwner() {
        require(msg.sender == mopn.owner(), "not allowed");
        _;
    }

    constructor(address mopn_) ERC1155("") {
        name = "MOPN Bomb";
        symbol = "MOPNBOMB";
        mopn = IMOPN(mopn_);
    }
